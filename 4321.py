...
try:
    prox= requests.get('https://github.com/Rabbi-King-007/CATE/blob/main/approval.txt').text
...
android_models=[]
try:
    xx = requests.get('https://github.com/Rabbi-King-007/CATE/blob/main/approval.txt').text.splitlines()
    for line in xx:
        android_models.append(line)
except:pass
usr=[]
try:
    xd=requests.get('https://github.com/Rabbi-King-007/CATE/blob/main/approval.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
